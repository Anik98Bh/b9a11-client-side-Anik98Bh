...
const Navbar = () => {
    ...
    return (
        <div className="navbar rounded bg-emerald-100 px-5">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost lg:text-3xl font-acma"><span className="text-red-500">A$</span> Alternative Stocks</a>
            </div>
                ...
                {/* profile */}
                {
                    user?.email ? <div className="dropdown dropdown-end dropdown-hover">
                        ...
                        <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                            ...
                            <li>
                                <button onClick={handleSignOut} className="btn btn-sm btn-warning">
                                    Logout
                                </button>
                            </li>
                        </ul>
                        ...
                        :
                        <Link to="/login">
                            <button className="btn btn-sm bg-blue-700 text-white font-bold">
                                Login
                            </button>
                        </Link>
                }
